    ...
    components: {
      schemas: {
        ...
        Address: {
          ...
          properties: {
            street: { type: 'string', example: 'PRACA ALFREDO EGYDIO DE SOUZA ARANHA' },
            number: { type: 'string', example: '100' },
            complement: { type: 'string', nullable: true, example: 'TORRE OLAVO SETUBAL' },
        ...
        Company: {
          ...
          properties: {
            ...
            email: { type: 'string', nullable: true, example: 'contato@itau.com.br' },
            phone: { type: 'string', nullable: true, example: '(11) 5029-1818' },
        ...
        DatasetResponse: {
          ...
          properties: {
            ...
            message: { type: 'string', example: 'Dataset generated successfully' },
        ...
        SingleCompanyResponse: {
          ...
          properties: {
            status: { type: 'string', enum: ['success'], example: 'success' },
            message: { type: 'string', example: 'Company data retrieved successfully' },
        ...
        ErrorResponse: {
          ...
          properties: {
            ...
            message: { type: 'string', example: 'The provided CNPJ is invalid' },
            details: {
              type: 'object',
              ...
              example: { cnpj: ['CNPJ must be exactly 14 digits (numbers only)'] },
            },
          },
        },
      },
      parameters: {
        CnpjPath: {
          ...
          description: '14-digit CNPJ — numbers only, no mask (e.g. `60746948000112`)',
          example: '60746948000112',
        },
        PageQuery: {
          name: 'page',
      ...
      responses: {
        ...
        ValidationError: {
          description: 'Request payload or query params failed Zod schema validation',
          content: {
            'application/json': {
              schema: { $ref: '#/components/schemas/ErrorResponse' },
              example: {
                ...
                details: { cnpj: ['CNPJ must be exactly 14 digits (numbers only)'] },
              },
            },
          },
        },
    ...
    paths: {
      '/health': {
        get: {
          ...
          description: 'Returns service uptime, timestamp and current environment.',
        ...
        get: {
          ...
          responses: {
            '200': {
              ...
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/SingleCompanyResponse' },
                },
              },
            },
            '400': { $ref: '#/components/responses/BadRequest' },
